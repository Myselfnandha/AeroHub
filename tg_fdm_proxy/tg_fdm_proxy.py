...
LOG_FILE_PATH = os.path.join(SCRIPT_DIR, "tg_fdm_proxy.log")
        ...
        for attempt in range(max_retries):
            try:
                ...
                if "disconnected" in err or "not connected" in err:
                    logger.warning("[RECONNECT] Telethon disconnected — attempting reconnect...")
                    try:
...
class LogDashboard:
    ...
    def _run_gui(self):
        ...
        try:
            ...
            return
        self.root.title("Telegram FDM Proxy - Log Dashboard")
        ...
        title_label = tk.Label(
            header, text="📡 TG FDM Proxy Log Monitor (Real-time)", 
        ...
        scrollbar = tk.Scrollbar(text_frame, bg="#0d1117", activebackground="#30363d")
        ...
        self.text_widget.tag_configure("info", foreground="#c9d1d9")
        ...
        self.root.after(100, self._poll_queue)
        self.root.after(100, self._tail_log)
    ...
    def _tail_log(self):
        ...
        if os.path.exists(LOG_FILE_PATH):
            ...
            lines = [f"Log file {LOG_FILE_PATH} does not exist yet.\n"]
        ...
        try:
            ...
            for line in lines:
                ...
                if " - WARNING - " in line or " - WARN - " in line:
                    tag = "warning"
                elif " - ERROR - " in line or " - CRITICAL - " in line or "Traceback" in line:
                    tag = "error"
            ...
            logger.error(f"Error updating log dashboard text: {e}")
