# Codebase Summary: media_control

## Overview
- **Scan Date:** 2026-06-12 18:52:20
- **Source Folder:** `C:\Users\NANDHA A\Desktop\FOLDERS\UTILITIES\services\media_control`
- **Total Text Files:** 10
- **Estimated Token Count:** 12,092
...
### File: `MediaControl.vbs`
- **Path:** `MediaControl.vbs`
- **Estimated Tokens:** 65
...
### File: `Volume_Control_Taskbar.vbs`
- **Path:** `Volume_Control_Taskbar.vbs`
...
### File: `debug_sessions.py`
- **Path:** `debug_sessions.py`
...
### File: `media_control.log`
- **Path:** `media_control.log`
- **Estimated Tokens:** 49
- **mtime:** 1780160075.363

```
2026-05-30 22:08:43,101 - INFO - CoInitializeEx returned 0
2026-05-30 22:08:43,558 - INFO - Active sessions count changed to: 1
2026-05-30 22:24:35,363 - INFO - Active sessions count changed to: 0
```

---

### File: `media_control.py`
- **Path:** `media_control.py`
- **Estimated Tokens:** 8,991
- **mtime:** 1781256547.573
...
### File: `run_media_control.bat`
- **Path:** `run_media_control.bat`
- **Estimated Tokens:** 15
- **mtime:** 1776794826.76
